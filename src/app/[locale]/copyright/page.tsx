...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Gamble With Your Friends',
    description: 'Copyright and intellectual property information for Gamble With Your Friends. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Gamble With Your Friends',
      description: 'Copyright and intellectual property information for Gamble With Your Friends.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Gamble With Your Friends. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Gamble With Your Friends and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Gamble With Your Friends is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Gamble With Your Friends Developers</strong> - Creators of the Gamble With Your Friends game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Gamble With Your Friends</strong> - Trademark of the game developers</li>
              <li><strong>Gamble With Your Friends</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Gamble With Your Friends.
            </p>
            ...
            <p>
              ...
              Gamble With Your Friends<br />
              Email: <a href="mailto:dmca@gamblewithyourfriends.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gamblewithyourfriends.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Gamble With Your Friends"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Gamble With Your Friends (gamblewithyourfriends.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@gamblewithyourfriends.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@gamblewithyourfriends.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@gamblewithyourfriends.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gamblewithyourfriends.wiki</a>
            </p>
            <p>
